export const StringsPortuguese = {
  /** Check Code */
  titleIndex: 'Digite o código de acesso da pesquisa para conseguir responder.',
  subtitleIndex: 'Sua participação é muito importante para sua Empresa',
  buttonIndex: 'RESPONDER',

  /** Informer */
  informerTitle: 'Olá',
  informerDescription:
    'Seja bem-vindo à pesquisa em pulso da Fluxo. Tire alguns minutos para responder as perguntas a seguir. Sua participação é extremamente importante e ajudará a compreender como é trabalhar na empresa. Desde já, agradecemos sua participação!',
